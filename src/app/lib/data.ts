...
export const faqMagnetisme = [
  {
    ...
    reponse:
      "Oui. L'énergie ne connaît pas de frontières physiques. De nombreuses personnes constatent des effets positifs lors de séances à distance.",
  },
  {
    question: "Combien de séances sont nécessaires ?",
    reponse:
      "Cela dépend de chaque personne et de la situation. Une seule séance peut suffire, d'autres personnes préfèrent un suivi sur plusieurs séances.",
  },
  {
